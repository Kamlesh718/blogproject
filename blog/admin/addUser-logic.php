...
// profile(file) is array
  ...
  if(!$firstname){
    ...
    $_SESSION['add-user']= 'Please enter your validate email ✉️';
  } elseif (strlen($createpassword < 8) || strlen($confirmpassword < 8)){
    $_SESSION['add-user']= '🔑 Password should be 8+ characters ';
  } elseif (!$profile['name']){
    $_SESSION['add-user']= 'Please select a profile image';
  } else {
  ...
  if(isset($_SESSION['add-user'])) {
    ...
    $insert_user_query = "INSERT INTO users SET firstname = '$firstname',lastname='$lastname',username='$username',email='$email',password='$hashed_password',profile='$profile_name',is_admin=$is_admin";
